...
function generateString($length = 32, $characters = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
{
    $randomString = null;
...
function getQueryString($key = null)
{
    if (isset($key)) {
        if (isset($_GET[$key])) {
            return $_GET[$key];
...
// Function to calculate and return the execution time in seconds since a global start time
...
function getClientOS($formatted = true)
{
